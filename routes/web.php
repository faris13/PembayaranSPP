...
//ini route login
Route::get('login/petugas','LoginController@viewLoginPetugas');
Route::post('login/petugas','LoginController@loginPetugasPost');

Route::get('login','LoginController@viewLoginSiswa');
...
Route::get('admin/export/pembayaran','AdminController@exportPembayaran');
